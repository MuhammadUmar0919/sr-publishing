...
export const AuthModal = ({ isOpen, onClose, mode, onSwitchMode }: AuthModalProps) => {
    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: mode === 'login' ? "Welcome back!" : "Welcome to SR Publishing House!",
        });
        onClose();
        ...
        toast({
          title: "Error",
          description: mode === 'login' ? "Invalid credentials" : "Registration failed",
          variant: "destructive"
        });
      }
    } catch (error) {
  ...
  const handleGoogleAuth = () => {
    toast({
      ...
      description: "Google sign-in will be implemented here.",
    });
  };
